		...
		<div class="edit_title edit" v-show="data.state == 'active'">
			<form>
				...
				<div class="input-group">
					...
					<input type="radio" name="color" id="color1" value="1" v-model="data.backgroundColorStyle">
					<label for="color1">默认颜色</label>&#x3000;&#x3000;
					<input type="radio" name="color" id="color2" value="2" v-model="data.backgroundColorStyle">
...
<script>
	...
	export default {
		...
		watch: {
			...
			data: {
				handler(curVal, oldVal) {
					if(curVal.backgroundColorStyle == '1') {
						curVal.backgroundColor = 'rgba(255,255,255,1)'
